    ...
    >
      <div className="mx-auto max-w-[1200px]">
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            className="mx-auto max-w-[700px] font-display text-[clamp(3rem, 7vw, 5.5rem)] font-normal tracking-[-0.03em] leading-[1.05] text-[#7b6bb2]"
          >
            ...
            >
              ...
              >
                ...
                <div className="p-7">
                  ...
                  <h3 className="mt-3 font-display text-[clamp(1.4rem, 2.2vw, 1.8rem)] font-normal leading-[1.15] tracking-[-0.02em] text-[#1a1a1a] group-hover:text-[#5e4985] transition-colors duration-200">
                    {post.title}
                  </h3>
